...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val eLeft:    EditText? = findViewById(R.id.eLeft)
        val eRight:   EditText? = findViewById(R.id.eRight)
        val eDensity: EditText? = findViewById(R.id.eDensity)
        val eOil:     EditText? = findViewById(R.id.eOil)
        ...
        eLeft?.addTextChangedListener(object :TextWatcher {                                         // Левый борт
        ...
        eRight?.addTextChangedListener(object :TextWatcher {                                        // Правый борт
            override fun beforeTextChanged(s: CharSequence?, start: Int, count: Int, after: Int) { }// Выполняется перед изменением текста.
            override fun afterTextChanged(s: Editable?) { }                                         // Выполняется после изменения текста.
            @SuppressLint("SetTextI18n")
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {     // Выполняется во время изменения текста.
        ...
        eDensity?.addTextChangedListener(object :TextWatcher {                                      // Плотность
            override fun beforeTextChanged(s: CharSequence?, start: Int, count: Int, after: Int) { }// выполняется перед изменением текста.
            override fun afterTextChanged(s: Editable?) { }                                         // выполняется после изменения текста.
            @SuppressLint("SetTextI18n")
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {     // выполняется во время изменения текста.
        ...
        eOil?.addTextChangedListener(object :TextWatcher {                                          // Масло
            override fun beforeTextChanged(s: CharSequence?, start: Int, count: Int, after: Int) { }// Выполняется перед изменением текста.
            override fun afterTextChanged(s: Editable?) { }                                         // Выполняется после изменения текста.
            @SuppressLint("SetTextI18n")
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {     // Выполняется во время изменения текста.
        ...
        bCount?.setOnClickListener {
            ...
            if (sDensity.isNotEmpty()) {
                ...
                val dDensity: Double = sDensity.toDouble()
                var dExpense: Double?
                var dLeft: Double? = null
                var dRight: Double? = null
                var dResult: Double? = null

                when(dDensity) {                                                                    // Расходка
                    in 0.0001..0.9999 ->  dExpense = dDensity * 70 * 22
                    else -> {
                        tOutputLeft?.text = "0"
                        tOutputRight?.text = "0"
                ...
                val sLeft = eLeft?.text.toString()                                                  // Левый борт
                if (sLeft.isNotEmpty()) {
                ...
                val sRight = eRight?.text.toString()                                                // Правый борт
            ...
            if (sOil.isNotEmpty()) {
                var dOil: Double = sOil.toDouble() * 0.910 * 22
